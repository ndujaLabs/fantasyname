 ...
 */
NameGen.symbols = {
  s: ['ach', 'ack', 'ad', 'age', 'ald', 'ale', 'an', 'and', 'ang', 'ar', 'ard',
  ...
  t: ['ban', 'bel', 'bur', 'cer',
    'cha', 'che', 'dan', 'dar', 'del', 'den', 'dra', 'dyn',
    'gar', 'gha', 'hat', 'hin', 'hon', 'kal', 'kel', 'kim', 'kin',
    'ler', 'lor', 'lye', 'mor', 'mos', 'nal', 'ny', 'nys',  'per', 'pol', 'qua', 'que', 'rad',
    'rak', 'ran', 'ray', 'ril', 'ris', 'rod', 'roth', 'ryn', 'sam',
    'say', 'ser', 'shy', 'skel', 'sul', 'tai', 'tan', 'tas', 'ther',
    'tia', 'tin', 'ton', 'tor', 'tur','ver', 'ves', 'vor', 'war', 'wor', 'yer', 'soo'],
  T: ['raa', 'sma', 'sdra', 'dra', 'dro','drugo', 'qua', 'fra', 'po', 'dong', 'woo', 'soo'],
  v: ['a', 'e', 'i', 'o', 'u', 'y'],
  ...
  z: ['rph', 'rrd', 'th', 'rd', 'rgh', 'ph', 'nord', 'bus', 'mus', 'nor', 'ajee', 'lf', 'lph',
    'rsst', 'rjz', 'hood', 'nnd', 'q', 'rq', 'rraq', 'rnoqq', 'shalt', 'hooq', 'kuyh', 'yoy'
  ],
  D: ['b', 'bl', 'br', 'cl', 'd', 'f', 'fl', 'fr', 'g', 'gh', 'gl', 'gr',
    'h', 'j', 'k', 'kl', 'm', 'n', 'p', 'th', 'w'],
  d: ['lch', 'k', 'lph', 'lt', 'ng', 'nk', 'rk', 'rm', 'ck', 'lf', 'zz', 'x', 'xx'],
  J: 'kua,kati,maka,ka,qua,pia,loa,la,bba,ja,nduja,ninja,nja,rato,legato,scia,sha,lla,llha,ssa,ffa,hoo'.split(','),
  O: 'ta,da,dda,tta,cro,gro,bro,dro,dragon,gon,phon,'.split(','),
  q: 'or,ar,eer,ord,iev,ier,oo,lar,oth,uth,ooth,at,ark,urk,oork,oq,eerk,uth,uddh,ood,alf,elf'.split(','),
  w: 'loth,phurr,pham,dham,garr,gharr,phar,shoor,woorph,rnoth,rpha,stradd,phaw,wham,whud,vrom,vrurst,whard,wuth,qark,loodd,ludh,leth,dalf,them,thoph,doph,draph,wraph,buq,rux,kolf,kwerd,kwad,kur,lpith,lza,zuka,tsu,tsoi,tsay,rjond,rgand,rland,rnust,rphoor'.split(',')
};
